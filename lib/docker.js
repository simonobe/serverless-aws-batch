...
function buildDockerImage() {
    ...
    COPY ${this.serverless.service.package.artifact} /tmp
    ...
    if (this.serverless.service.provider.runtime === 'nodejs8.10') dockerFileContents = dockerFileContents.concat(
    ...
    if (this.serverless.service.provider.runtime === 'nodejs10.x') dockerFileContents = dockerFileContents.concat(
